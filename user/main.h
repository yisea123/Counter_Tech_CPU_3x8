...
#include "Fill_bottle_system.h"
#include "Counter_Tech_CPU_Main.h"
#include "dac.h"
#include "delay.h"
#include "usart.h"
#include "my_cmd.h"
...
#define MONTH (__DATE__ [2] == 'n' ? (__DATE__ [1] == 'u' ? 5 : 0) \
						: __DATE__ [2] == 'b' ? 1 \
...
#define PROGRAM_VERSION "CounterTech V2.0"
#define COMPILE_TIME "(Compile Time:", __DATE__, __TIME__, ")"
#define PRINT_VERSION() my_print ("Software Version:%s\nCompile Time:%d-%02d-%02d %s",PROGRAM_VERSION, YEAR, MONTH + 1, DAY, __TIME__);  
...
#define DMA1_7_INT_PREEM INT_GROUP_2
#define DMA1_7_INT_SUB 1
...
#define UART1_RX_INT_SUB 2
#define UART3_RX_INT_PREEM INT_GROUP_2
#define UART3_RX_INT_SUB 3
